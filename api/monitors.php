...
if ($method === 'GET') {
    ...
    $stmt = $pdo->prepare("INSERT INTO monitors (id, name, category, type, target, check_interval, status, latency, uptime) VALUES (?, ?, ?, ?, ?, ?, 'operational', 15, 100.0)");
    $stmt->execute([$id, $name, $category, $type, $target, $interval]);
